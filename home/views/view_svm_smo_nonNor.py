...
from home.views import m_svm_smo_nonNor


class IndexView(ListView):
    template_name = 'home_svm_smo_nonNor.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            data_training = m_svm_smo_nonNor.calculate_svm_smo(tahun, epsilon, constant, k_fold)

...
from home.views import m_svm_seq_nonNor


class IndexView(ListView):
    template_name = 'home_svm_seq_nonNor.html'
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            data_training = m_svm_seq_nonNor.calculate_svm_seq(tahun, constant, iterasi, gamma, k_fold)

...
from home.views import view_data, view_normalisasi, view_naivebayes, view_svm_seq, view_svm_smo, view_decissiontree, view_decissiontree_nonNor, view_svm_seq_nonNor, view_svm_smo_nonNor, view_naivebayes_nonNor
